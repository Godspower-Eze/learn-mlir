...
config.name = "learn-mlir"
config.test_format = ShTest()
config.suffixes = [".mlir"]

# lit executes relative to the directory
#
#   bazel-bin/tests/<test_target_name>.runfiles/learn-mlir/
#
...
#
# Bazel defines RUNFILES_DIR which includes learn-mlir/ and third party
# dependencies as their own directory. Generally, it seems that $PWD ==
# $RUNFILES_DIR/learn-mlir/
